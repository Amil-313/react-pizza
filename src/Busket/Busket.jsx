...
import { removeBusketPizza, addBusketPizza, clearBusketPizza } from '../Redux/Slices/busketSlice';


function Busket() {
    const dispatch = useDispatch();
    const { busketPizza, totalPrice } = useSelector((state) => state.busketPizza);
        ...
        <div className='busket_main'>
            <div className="busket_products">
                ...
                <div className="busket_head">
                    ...
                    <div onClick={() => dispatch(clearBusketPizza())} className="busket_clear">
                ...
                {busketPizza.map((item, i) => <Busketitem key={i} item={item} />)}

            </div>
            

            <div className="add_sum">
                <p>Всего пицц: <strong>{busketPizza.reduce((sum, pre) => { return sum + pre.count}, 0)} шт.</strong></p>
