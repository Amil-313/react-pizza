            ...
            <header>
                    ...
                    <div className="header">
                        ...
                        <div className="search">
                            ...
                            <input onChange={(event) => setSearch(event.target.value)} value={search} type="text" placeholder='Поиск пиццы...' />
                            {search && <svg onClick={() => setSearch('')} className='input_clear' height="20" viewBox="0 0 48 48" width="20" xmlns="http://www.w3.org/2000/svg">
